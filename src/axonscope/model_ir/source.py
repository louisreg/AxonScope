...
SOURCE_COMPILER_VERSION = "source_codegen.v16"
...
def _generated_module_source(
    ...
    *,
    ...
    runtime_contract = _generated_runtime_contract(model)
    return (
        ...
        "RUNTIME_CONTRACT_VERSION = 'jax_membrane_runtime.v1'\n"
    )


def _generated_runtime_contract(model: ModelIR) -> dict[str, Any]:
    program = membrane_program_from_model_ir(model)
    step = model.step_program
    return {
        "version": "jax_membrane_runtime.v1",
