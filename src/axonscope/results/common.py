...
class SingleAxonResultMixin:
    ...
    def time_values(self, *, unit: Any = "millisecond"):
        ...
        from axonscope.results.views import time_values
    ...
    def position_values(self, *, unit: Any = "micrometer"):
        ...
        from axonscope.results.views import position_values
    ...
    def voltage_values(self, *, unit: Any = "millivolt"):
        ...
        from axonscope.results.views import voltage_values
    ...
    def peak_voltage_values(self, *, unit: Any = "millivolt"):
        ...
        from axonscope.results.views import peak_voltage_values
    ...
    def nearest_position_index(self, position: Any) -> int:
        ...
        from axonscope.results.views import nearest_position_index
    ...
    def trace_values(
        ...
        *,
        ...
        from axonscope.results.views import trace_values
    ...
    def plot_trace(
        ...
        **plot_kwargs: Any,
        ...
        from axonscope.results.views import plot_trace
    ...
    def plot_traces(
        ...
        **plot_kwargs: Any,
        ...
        from axonscope.results.views import plot_traces
    ...
    def plot_peak_voltage(
        ...
        **plot_kwargs: Any,
        ...
        from axonscope.results.views import plot_peak_voltage
    ...
    def plot_recorded_axis(
        ...
        *,
        ...
        from axonscope.results.views import plot_recorded_axis
    ...
    def plot_recording_group(
        ...
        **plot_kwargs: Any,
        ...
        from axonscope.results.views import plot_recording_group
    ...
    def plot_map(
        ...
        **imshow_kwargs: Any,
        ...
        from axonscope.results.views import plot_map
