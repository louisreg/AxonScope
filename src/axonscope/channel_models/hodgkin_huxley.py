...
class HHNaICM(IonChannelModelBase):
    """
    Mono-Na channel following the exact Hodgkin-Huxley kinetics.
    For testing purposes
    Gates: m, h
    Produces 1 channel: g_Na
    """
...
class HHKICM(IonChannelModelBase):
    """
    Mono-K channel following exact Hodgkin-Huxley kinetics.
    For testing purposes
    Gate: n
    Produces 1 channel: g_K
    """
...
class HHLeakICM(IonChannelModelBase):
    """
    Leak-only HH channel.
    For testing purposes
    No gates.
    Produces 1 channel: g_L
    """
