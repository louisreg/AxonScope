...
from axonscope.analysis import ActivationEvent, AnalysisResult, AnalysisStatus
from axonscope.protocols.types import ThresholdStatus
from axonscope.utils import units


@dataclass(frozen=True)
class ThresholdHistoryEntry:
    """One criterion evaluation performed during threshold search."""
...
class ThresholdSearchResult:
    """Single-row result returned by ``find_threshold``-style bisection.

    ``status`` uses the protocol-level ``ThresholdStatus`` vocabulary: it
    describes the search outcome relative to the supplied bounds, not row
    validity or analysis applicability.
    """
    ...
    def rows(self, *, unit: Any = "microampere") -> tuple[dict[str, Any], ...]:
        ...
        from axonscope.protocols.views import threshold_search_rows

        return threshold_search_rows(self, unit=unit)
    ...
    def to_analysis_result(
        ...
        *,
        ...
        """Return this search outcome as a one-row analysis metric."""

        value, status, message = _threshold_status_as_analysis(
            self.status,
            self.amplitude_uA,
        )
    ...
    def format(self, *, unit: Any = "microampere") -> str:
        ...
        from axonscope.protocols.views import format_threshold_search

        return format_threshold_search(self, unit=unit)

    def print(self, file: TextIO | None = None, *, unit: Any = "microampere") -> None:
        """Print a compact text representation."""

        from axonscope.protocols.views import print_threshold_search

        print_threshold_search(self, file=file, unit=unit)

    def to_dataframe(self, *, unit: Any = "microampere") -> Any:
        """Return a pandas DataFrame summary."""

        from axonscope.protocols.views import threshold_search_to_dataframe

        return threshold_search_to_dataframe(self, unit=unit)
    ...
    def plot(
        ...
        **plot_kwargs: Any,
        ...
        from axonscope.protocols.views import plot_threshold_search

        return plot_threshold_search(self, ax=ax, unit=unit, **plot_kwargs)
...
class RecruitmentCurve:
    ...
    def rows(self, *, unit: Any = "microampere") -> tuple[dict[str, Any], ...]:
        ...
        from axonscope.protocols.views import recruitment_curve_rows
    ...
    def format(self, *, unit: Any = "microampere") -> str:
        ...
        from axonscope.protocols.views import format_recruitment_curve
    ...
    def print(self, file: TextIO | None = None, *, unit: Any = "microampere") -> None:
        ...
        from axonscope.protocols.views import print_recruitment_curve
    ...
    def to_dataframe(self, *, unit: Any = "microampere") -> Any:
        ...
        from axonscope.protocols.views import recruitment_curve_to_dataframe
    ...
    def plot(
        ...
        **plot_kwargs: Any,
        ...
        from axonscope.protocols.views import plot_recruitment_curve
    ...
    def plot_groups(
        ...
        **plot_kwargs: Any,
        ...
        from axonscope.protocols.views import plot_recruitment_groups
...
class PoolSweepResult:
    ...
    def rows(
        ...
        *,
        ...
        from axonscope.protocols.views import pool_sweep_rows
    ...
    def format(
        ...
        *,
        ...
        from axonscope.protocols.views import format_pool_sweep
    ...
    def print(
        ...
        *,
        ...
        from axonscope.protocols.views import print_pool_sweep
    ...
    def to_dataframe(
        ...
        *,
        ...
        from axonscope.protocols.views import pool_sweep_to_dataframe
    ...
    def plot(
        ...
        **plot_kwargs: Any,
        ...
        from axonscope.protocols.views import plot_pool_sweep
...
class ThresholdCurve:
    ...
    def rows(
        ...
        *,
        ...
        from axonscope.protocols.views import threshold_curve_rows
    ...
    def format(
        ...
        *,
        ...
        from axonscope.protocols.views import format_threshold_curve
    ...
    def print(
        ...
        *,
        ...
        from axonscope.protocols.views import print_threshold_curve
    ...
    def to_dataframe(
        ...
        *,
        ...
        from axonscope.protocols.views import threshold_curve_to_dataframe
    ...
    def plot(
        ...
        **plot_kwargs: Any,
        ...
        from axonscope.protocols.views import plot_threshold_curve
