...
class PreparedRuntimeInputSummary:
    ...
    @property
    def intracellular_mode(self) -> IntracellularLoweringMode:
        """Semantic intracellular mode implied by the concrete format."""

        return intracellular_mode_from_format(self.intracellular_format)
