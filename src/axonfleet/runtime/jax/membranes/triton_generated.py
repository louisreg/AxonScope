...
from axonfleet.runtime.jax.kernels.triton_call_cache import cached_triton_call
...
def load_generated_triton_module(program: Any) -> Any | None:
    ...
    if cached is not None:
        return cached
    module_name = f"axonfleet_model_codegen_{cache_key}_triton"
    ...
    *,
    ...
    gates_out, gm, ge = cached_triton_call(
        ...
        *tuple(parameters),
        ...
        grid=grid,
        name=f"axonfleet_generated_membrane_{module.CACHE_KEY[:12]}",
        TOTAL=total,
