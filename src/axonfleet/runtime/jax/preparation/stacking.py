...
from axonfleet.runtime.jax.membranes.backend import RowIndexedMembraneBackend
from axonfleet.runtime.jax.membranes.stacking import (
    try_stack_gated_leak_membrane_from_group,
)
from axonfleet.runtime.jax.preparation.base import prepare_membrane_runtime
...
def _with_batched_double_cable_runtime(
    ...
    with benchmark_span(
        ...
        extracellular = _stack_extracellular_runtime(
            materialized_axons,
            dtype_local=dtype_local,
        )
    return replace(
