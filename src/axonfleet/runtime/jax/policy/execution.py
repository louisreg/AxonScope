...
from axonfleet.runtime.policy import RuntimeKind
from axonfleet.runtime.jax.compilation_cache import configure_jax_compilation_cache
...
def jax_execution_context(
    ...
    *,
    ...
    if not isinstance(policy, ExecutionPolicy):
        raise TypeError("execution_policy must be an axonfleet.ExecutionPolicy value.")
    ...
    *,
    ...
    if mismatches:
        raise ValueError(
            ...
            "AxonFleet does not cast membrane/runtime precision implicitly; "
