...
from axonfleet.runtime.outputs.assembly import (
    ...
    *,
    ...
    with benchmark_span(
        ...
        pending = (
            ...
            else PendingThresholdObservation(
                plan=out.pending_observation.plan,
                state=out.pending_observation.state[:size],
                nt=out.pending_observation.nt,
                dt_ms=out.pending_observation.dt_ms,
            )
        )
