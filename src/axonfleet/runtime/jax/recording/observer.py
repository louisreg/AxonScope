...
from axonfleet.runtime.benchmarking import benchmark_wait
from axonfleet.analysis.core import AnalysisResult, AnalysisStatus
...
from axonfleet.results.vm_raster import VM_RASTER_OBSERVATION_KEY, VmRasterResult
    ...
    *,
    ...
    for definition in raster_defs:
        ...
        if not isinstance(target, PositionSelector):
            raise TypeError("VmRaster target must be an axonfleet PositionSelector.")
