...
from axonfleet.recording import Recording, RecordingPlan
...
def execution_context(
    ...
    *,
    ...
    from axonfleet.runtime.jax.policy.execution import jax_execution_context
...
def benchmark_plan_input_lowering(
    *,
    ...
    from axonfleet.runtime.jax.benchmarking.profile import (
...
def benchmark_profile_start(
    ...
    *,
    ...
    if resolved is None:
        return None
    if resolved == "jax":
        from axonfleet.runtime.jax.benchmarking.profile import benchmark_profile_start as start
...
def benchmark_device_memory_snapshot(
    *,
    ...
    if resolved == "jax":
        from axonfleet.runtime.jax.benchmarking.memory import (
...
def solver_route_from_execution_policy(
    ...
    if policy is None:
        return None
    from axonfleet.runtime.jax.policy.execution import jax_solver_engine_for_policy
    ...
    return RuntimeSolverRoute(
        ...
        double_cable=CableSolverRoute(
            ...
            internal=solver_engine.platform == "gpu",
...
def enqueue_batch_group(
    ...
    *,
    ...
    from axonfleet.runtime.jax.group_runner import enqueue_jax_batch_group
...
def finalize_batch_group(pending: Any):
    ...
    from axonfleet.runtime.jax.group_runner import finalize_jax_batch_group
