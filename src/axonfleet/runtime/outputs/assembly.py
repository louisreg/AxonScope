...
class _PosthocResultRow(SingleAxonResultMixin):
    """Minimal one-row result used to evaluate analyses from retained Vm."""
...
def dispatch_results_from_batch(
    ...
    *,
    ...
    kernel_batch_options: OutputPlan,
