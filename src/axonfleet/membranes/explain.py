...
from axonfleet.model_ir.expressions import BinaryOp, Call, Expression, Literal, Symbol, UnaryOp
from axonfleet.model_ir.schema import ModelIR, ModelSymbol
from axonfleet.model_ir.serialization import model_ir_from_json
...
def explain(model: MembraneModel) -> MembraneModelExplanation:
    ...
    treating AxonFleet's internal representation as a public API.
    """
...
def format_membrane_model_explanation(report: MembraneModelExplanation) -> str:
    ...
    lines = [
        "AxonFleet membrane model explanation",
