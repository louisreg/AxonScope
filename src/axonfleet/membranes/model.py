...
def section(name: str, **metadata: Any) -> Callable[[SectionFunction], SectionFunction]:
    ...
    def decorate(function: SectionFunction) -> SectionFunction:
        setattr(function, "__axonfleet_section__", section_name)
        setattr(function, "__axonfleet_section_metadata__", dict(metadata))
        return function
...
class Model(metaclass=_MembraneModelClass):
    ...
    def _build_membrane_descriptor(self) -> "MembraneModel":
        from axonfleet.membranes.compiler import parameterized_membrane_model
    ...
    def params(self) -> Mapping[str, Any]:
        ...
        return self._membrane_descriptor().params
...
class MembraneModel:
    ...
    def inspect_generated_code(self, **kwargs: Any) -> Any:
        ...
        from axonfleet.membranes.generated_code import inspect_generated_code
    ...
    def explain(self) -> Any:
        ...
        from axonfleet.membranes.explain import explain
