...
class VmRasterResult:
    ...
    def rows(self) -> tuple[dict[str, Any], ...]:
        ...
        from axonfleet.results.views import vm_raster_rows
    ...
    def to_dataframe(self) -> Any:
        ...
        from axonfleet.results.views import vm_raster_to_dataframe
    ...
    def format(self) -> str:
        ...
        from axonfleet.results.views import format_vm_raster
    ...
    def print(self, file: TextIO | None = None) -> None:
        ...
        from axonfleet.results.views import print_vm_raster
    ...
    def plot(
        ...
        *,
        ...
        from axonfleet.results.views import plot_vm_raster
...
def _require_vm_raster_definition(definition: Any) -> None:
    ...
    if not isinstance(getattr(definition, "target"), PositionSelector):
        raise TypeError("VmRaster definitions must use axonfleet PositionSelector targets.")
