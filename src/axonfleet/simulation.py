...
from axonfleet.axon_instance import AxonInstance, simulation_structure_revision
...
from axonfleet.dispatcher.execution import run_pool
...
def _run_population_simulation(
    ...
    *,
    ...
    dictionary.
    ``recording`` controls the public output contract. ``batch_options`` only
    ...
    with benchmark_span("simulation.setup"):
        ...
        duration_ms, step_ms = resolve_time(duration=duration, dt=dt)
