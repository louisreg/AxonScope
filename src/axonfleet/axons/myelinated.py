...
from axonfleet.membranes import SectionLayout
...
class Myelinated(Axon):
    ...
    def _node_mask(self) -> np.ndarray:
        mask: list[bool] = []
    ...
    def node_indices(self) -> np.ndarray:
        ...
        return np.where(self._node_mask())[0].astype(np.int32)
    ...
    def node_position_values(self, *, unit: Any = "micrometer") -> np.ndarray:
        ...
        return self.layout.position_values(unit=unit)[self.node_indices]
