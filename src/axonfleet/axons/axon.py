...
from axonfleet.axons.formulation import (
    CableFormulation,
    Formulation,
...
class Axon:
    ...
    def __init__(
        ...
        *,
        ...
        formulation:
            Optional cable formulation. When omitted, AxonFleet infers it from
        ...
        if not isinstance(layout, Layout):
            raise TypeError("layout must be an axonfleet.axons.Layout.")
        self._layout: Layout
        self.layout = layout
