...
from axonfleet.utils.validation import normalize_positive_int, require_positive
...
class Layout:
    ...
    def plot(self, ax=None, **kwargs):
        ...
        from axonfleet.axons.plotting import plot_layout
