...
def normalize_unit(unit: Any) -> str:
    """Return AxonFleet's canonical compact spelling for a public unit."""

    candidates = [str(unit)]
    try:
        from axonfleet.utils.units import unit_label
...
def quantity_literal(value: Any) -> tuple[int | float | bool, str] | None:
    ...
    from axonfleet.utils.units import to_scalar
