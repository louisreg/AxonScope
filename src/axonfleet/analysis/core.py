...
@dataclass(frozen=True)
class _AnalysisInputRequirement:
...
class AnalysisResult:
    ...
    input_requirements: Sequence[_AnalysisInputRequirement | None] = ()
    ...
    def rows(self) -> tuple[dict[str, Any], ...]:
        ...
        from axonfleet.analysis.views import analysis_result_rows
    ...
    def to_dataframe(self) -> Any:
        ...
        from axonfleet.analysis.views import analysis_result_to_dataframe
    ...
    def format(self) -> str:
        ...
        from axonfleet.analysis.views import format_analysis_result
    ...
    def print(self, file: TextIO | None = None) -> None:
        ...
        from axonfleet.analysis.views import print_analysis_result
    ...
    def plot(self, ax: Any | None = None, **plot_kwargs: Any) -> Any:
        ...
        from axonfleet.analysis.views import plot_analysis_result
...
class AnalysisReport:
    ...
    def rows(self) -> tuple[dict[str, Any], ...]:
        ...
        from axonfleet.analysis.views import analysis_report_rows
    ...
    def format(self) -> str:
        ...
        from axonfleet.analysis.views import format_analysis_report
    ...
    def print(self, file: TextIO | None = None) -> None:
        ...
        from axonfleet.analysis.views import print_analysis_report
    ...
    def to_dataframe(self) -> Any:
        ...
        from axonfleet.analysis.views import analysis_report_to_dataframe
    ...
    def plot(self, ax: Any | None = None, **plot_kwargs: Any) -> Any:
        ...
        from axonfleet.analysis.views import plot_analysis_report

        return plot_analysis_report(self, ax=ax, **plot_kwargs)


class _AnalysisDefinition(Protocol):
...
class _MissingAnalysisInputError(ValueError):
    ...
    def __init__(
        ...
        *,
        ...
        self.requirement = _AnalysisInputRequirement(
            message=message,
...
class _AnalysisNotApplicableError(ValueError):
    """Raised when an analysis does not apply to a result row."""


def analyze(result: Any, *definitions: _AnalysisDefinition) -> AnalysisResult | AnalysisReport:
    ...
    if len(analyses) == 1:
        return analyses[0]
    return AnalysisReport(analyses=tuple(analyses))
