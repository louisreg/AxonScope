...
def _recorded_positions_um(result: Any) -> np.ndarray:
...
def _recorded_indices(result: Any) -> np.ndarray:
...
def _spatially_filter_recording(
    ...
    *,
    ...
    original_indices = _recorded_indices(result)
...
def rasterize(
    ...
    *,
    ...
    positions_um = _recorded_positions_um(result)
