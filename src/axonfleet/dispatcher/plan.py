...
def dispatch_method_label(*, mode: str, geometry_shared: bool) -> str:
    """Return the canonical diagnostic method label for a dispatch group."""

    prefix = "batch" if geometry_shared else "parameter-batch"
    return f"{prefix}-{mode}-cable"
...
class DispatchGroup:
    ...
    def dispatch_method(self) -> str:
        """Return the canonical diagnostic method label for this group."""
