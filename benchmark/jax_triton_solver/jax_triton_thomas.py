"""Benchmark-only jax-triton exact block-Thomas solver candidate."""
...
def jax_triton_thomas_dependency_skip_reason() -> str | None:
    """Return why the benchmark-only jax-triton backend cannot run, if anything."""
...
def solve_block_tridiagonal_2x2_jax_triton_thomas(
    a00: Any,
    a01: Any,
    a10: Any,
    a11: Any,
    ...
    """Solve batched 2x2 block-tridiagonal systems via jax-triton."""
