...
RUNTIME_SUITES: dict[str, RuntimeSuite] = {
    ...
    "model_codegen": RuntimeSuite(
        name="model_codegen",
        description="Class-based membrane source/codegen plus model-step smoke benchmark.",
    ...
    "model_codegen_simulations": RuntimeSuite(
        name="model_codegen_simulations",
        description="Tiny public AxonSimulation first/warm runs for class-based model templates.",
        runner="model_codegen",
        args=(
            "--models",
            "passive",
    ...
    "model_codegen_all": RuntimeSuite(
        ...
        description="Full built-in plus custom source/codegen, model-step, and template simulation benchmark.",
        runner="model_codegen",
        args=(
            "--models",
            "all",
