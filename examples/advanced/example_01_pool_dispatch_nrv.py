"""Advanced example 01: inspect dispatch for a heterogeneous axon pool.

Run:
    python examples/advanced/example_01_pool_dispatch_nrv.py --fibers 12 --include-mrg
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    extracellular = make_extracellular_context(length=length)
    simulations = tuple(
        build_simulation(
            row,
            length=length,
...
def make_extracellular_context(*, length: Any) -> axs.AnalyticalExtracellularContext:
