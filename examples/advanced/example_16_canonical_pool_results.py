"""Advanced example 16: canonical pool results.

Run:
    python examples/advanced/example_16_canonical_pool_results.py
...
def main() -> None:
    ...
    print(f"first y position: {first.simulation.y_um:g} um")
    print(f"second y position: {second.simulation.y_um:g} um")
